...
The evaluators check that the role exists, RLS is enabled on the three tables, the function exists, and that theme_analyst sees exactly 2 Star Wars sets (behavioral verification).
"""
