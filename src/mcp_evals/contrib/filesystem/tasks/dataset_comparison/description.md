...
4. **Output**: Generate an analysis.txt file in the working directory showing the mapping and counts

### Expected Output

Create a file named `analysis.txt` in the working directory root with the following format:
